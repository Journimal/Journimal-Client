...
class MissionSurvey4Screen extends StatefulWidget {
  const MissionSurvey4Screen({super.key});

  @override
  _MissionSurvey4ScreenState createState() => _MissionSurvey4ScreenState();
}

class _MissionSurvey4ScreenState extends State<MissionSurvey4Screen> {
    ...
    return Scaffold(
      appBar: PreferredSize(
        ...
        child: AppBar(
          ...
          title: const Text('Don’t waste food'),
        ),
      ),
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            Image.asset(
              'assets/images/mission_photo/m_ph_4.png',
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text(
                    'Order only what you need and avoid leaving leftovers.',
                    style: TextStyle(
            ...
            _buildQuestion(
              question:
                  'Did you order smaller portions if you weren’t very hungry?',
              value: firstquestion,
              onChanged: (value) {
                setState(() {
                  firstquestion = value;
