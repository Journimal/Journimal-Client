...
class MissionSurvey8Screen extends StatefulWidget {
  const MissionSurvey8Screen({super.key});

  @override
  _MissionSurvey8ScreenState createState() => _MissionSurvey8ScreenState();
}

class _MissionSurvey8ScreenState extends State<MissionSurvey8Screen> {
    ...
    return Scaffold(
      appBar: PreferredSize(
        ...
        child: AppBar(
          ...
          title: const Text('Buy eco-friendly souvenirs'),
        ),
      ),
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            Image.asset(
              'assets/images/mission_photo/m_ph_8.png',
