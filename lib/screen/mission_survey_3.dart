...
class MissionSurvey3Screen extends StatefulWidget {
  const MissionSurvey3Screen({super.key});

  @override
  _MissionSurvey3ScreenState createState() => _MissionSurvey3ScreenState();
}

class _MissionSurvey3ScreenState extends State<MissionSurvey3Screen> {
    ...
    return Scaffold(
      appBar: PreferredSize(
        ...
        child: AppBar(
          ...
          title: const Text('Turn off unnecessary electricity'),
        ),
      ),
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            Image.asset(
              'assets/images/mission_photo/m_ph_3.png',
            ...
            _buildQuestion(
              question:
                  'Did you unplug chargers or devices that were not in use?',
